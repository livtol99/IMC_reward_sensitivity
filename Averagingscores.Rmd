...
sub <- df_CBM %>% select(c((1:7),EEfRT_averaged_lowp, EEfRT_averaged_medp, EEfRT_averaged_highp, TEPS_ANT, TEPS_CON, MASQ_GD, MASQ_AD, MASQ_AA, BAS_Drive, BAS_FS, BAS_RR, BIS))
...
- For the low probabilit category, a small positive correlation (0.29) was found between the averaged EEfRT score and the MASQ.AA measure (p<0.05). Otherwise, no significant correlations were found for this probability category and the rest of the measure
